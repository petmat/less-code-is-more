...
![Serverless TypeScript](./title.jpg)
...
This is a nice starting point though I'd personally change the `target` to something a bit newer like `es2017`. And I would set `strict` to `true`. In [Part 1](../id-like-some-types/) of this blog post series, I wrote about the reasons why I think the strict mode is great so you can go back read about it if you're not yet convinced.
